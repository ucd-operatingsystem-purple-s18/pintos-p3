...
{    
    ...
    pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/mmap-bad-fd -a mmap-bad-fd -- -q  -f run mmap-bad-fd < /dev/null 2> tests/vm/mmap-bad-fd.errors |tee tests/vm/mmap-bad-fd.output
    echo -e "\n   RESULT: \n"
...
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/args-single -a args-single -- -q  -f run 'args-single onearg' < /dev/null 2> tests/vm/args-single.errors |tee tests/vm/args-single.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/args-single.ck tests/vm/args-single tests/vm/args-single.result
# }

# test-args-multiple() 
# {    
#     echo -e "\n   RUNNING TEST:   args-multiple \n"
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/args-multiple -a args-multiple -- -q  -f run 'args-multiple some arguments for you!' < /dev/null 2> tests/vm/args-multiple.errors |tee tests/vm/args-multiple.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/args-multiple.ck tests/vm/args-multiple tests/vm/args-multiple.result
# }

# test-args-many() 
# {    
#     echo -e "\n   RUNNING TEST:   args-many \n"
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/args-many -a args-many -- -q  -f run 'args-many a b c d e f g h i j k l m n o p q r s t u v' < /dev/null 2> tests/vm/args-many.errors |tee tests/vm/args-many.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/args-many.ck tests/vm/args-many tests/vm/args-many.result
# }

# test-args-dbl-space() 
# {    
#     echo -e "\n   RUNNING TEST:   args-dbl-space \n"
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/args-dbl-space -a args-dbl-space -- -q  -f run 'args-dbl-space two  spaces!' < /dev/null 2> tests/vm/args-dbl-space.errors |tee tests/vm/args-dbl-space.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/args-dbl-space.ck tests/vm/args-dbl-space tests/vm/args-dbl-space.result
# }

# test-sc-bad-sp() 
# {    
#     echo -e "\n   RUNNING TEST:   sc-bad-sp \n"
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/sc-bad-sp -a sc-bad-sp -- -q  -f run sc-bad-sp < /dev/null 2> tests/vm/sc-bad-sp.errors |tee tests/vm/sc-bad-sp.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/sc-bad-sp.ck tests/vm/sc-bad-sp tests/vm/sc-bad-sp.result
# }

# test-sc-bad-arg() 
# {    
#     echo -e "\n   RUNNING TEST:   sc-bad-arg \n"
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/sc-bad-arg -a sc-bad-arg -- -q  -f run sc-bad-arg < /dev/null 2> tests/vm/sc-bad-arg.errors |tee tests/vm/sc-bad-arg.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/sc-bad-arg.ck tests/vm/sc-bad-arg tests/vm/sc-bad-arg.result
# }

# test-sc-boundary() 
# {    
#     echo -e "\n   RUNNING TEST:   sc-boundary \n"
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/sc-boundary -a sc-boundary -- -q  -f run sc-boundary < /dev/null 2> tests/vm/sc-boundary.errors |tee tests/vm/sc-boundary.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/sc-boundary.ck tests/vm/sc-boundary tests/vm/sc-boundary.result
# }

# test-sc-boundary-2() 
# {    
#     echo -e "\n   RUNNING TEST:   sc-boundary-2 \n"
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/sc-boundary-2 -a sc-boundary-2 -- -q  -f run sc-boundary-2 < /dev/null 2> tests/vm/sc-boundary-2.errors |tee tests/vm/sc-boundary-2.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/sc-boundary-2.ck tests/vm/sc-boundary-2 tests/vm/sc-boundary-2.result
# }

# test-sc-boundary-3() 
# {    
#     echo -e "\n   RUNNING TEST:   sc-boundary-3 \n"
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/sc-boundary-3 -a sc-boundary-3 -- -q  -f run sc-boundary-3 < /dev/null 2> tests/vm/sc-boundary-3.errors |tee tests/vm/sc-boundary-3.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/sc-boundary-3.ck tests/vm/sc-boundary-3 tests/vm/sc-boundary-3.result
# }

# test-halt() 
# {    
#     echo -e "\n   RUNNING TEST:   halt \n"
#     pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/halt -a halt -- -q  -f run halt < /dev/null 2> tests/vm/halt.errors |tee tests/vm/halt.output
#     echo -e "\n   RESULT: \n"
#     perl -I../.. ../../tests/vm/halt.ck tests/vm/halt tests/vm/halt.result
# }
